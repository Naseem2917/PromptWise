  ...
  return (
    ...
    >
      ...
      <div className="rounded-2xl border border-red-200 dark:border-red-500/20 bg-red-50/60 dark:bg-red-500/[0.04] p-5 shadow-xs">
        ...
        <p className="text-slate-800 dark:text-slate-300 text-sm leading-relaxed">{originalPrompt}</p>
      </div>

      {/* After */}
      <div className="rounded-2xl border border-indigo-200 dark:border-indigo-500/30 bg-indigo-50/60 dark:bg-indigo-500/[0.05] p-5 shadow-xs">
