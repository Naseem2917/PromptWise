        ...
        <div className="flex items-center gap-2.5 sm:gap-4 shrink-0">
          ...
          {!loading && !user && (
            <button
              ...
              disabled={signingIn}
              className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 text-white text-xs sm:text-sm font-semibold px-3.5 py-2 rounded-xl transition-all duration-200 shadow-lg shadow-indigo-500/25 cursor-pointer disabled:opacity-60 min-h-[44px]"
            >
              {signingIn ? (
                <>
            ...
            <div className="relative">
              ...
              >
                <img
                  ...
                  className="w-8 h-8 rounded-full border-2 border-indigo-500/40"
                />
              ...
              <AnimatePresence>
                {dropdownOpen && (
                  ...
                  >
                    <div className="px-4 py-2 border-b border-slate-100 dark:border-white/[0.06] mb-1">
                      <p className="text-slate-900 dark:text-slate-100 text-sm font-semibold truncate">{user.displayName}</p>
