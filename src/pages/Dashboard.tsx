...
function PromptDetailModal({
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 z-50 flex items-center justify-center p-4 pb-24 md:pb-4 bg-slate-950/60 backdrop-blur-xs"
      onClick={onClose}
    >
      <motion.div
        ...
        className="w-full max-w-2xl max-h-[calc(100vh-7.5rem)] max-h-[calc(100dvh-7.5rem)] md:max-h-[90vh] overflow-y-auto bg-white dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl"
